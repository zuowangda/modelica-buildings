...
model OnlyExteriorWallWithWindow
  "Buoyancy force driven natural convection in a room with only exterior walls and windows"
  ...
  extends
    ...
    roo(nConExt=nConExt,
        ...
        datConExt(name={"North Wall","South Wall","Floor","Ceiling"},
                  ...
                  boundaryCondition={Buildings.Rooms.Types.CFDBoundaryConditions.Temperature,
                                     ...
                                     Buildings.Rooms.Types.CFDBoundaryConditions.Temperature,
                                     Buildings.Rooms.Types.CFDBoundaryConditions.Temperature}),
        datConExtWin(name={"East Wall","West Wall"},
